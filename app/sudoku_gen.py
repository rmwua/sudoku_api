...
class SudokuGen:
    ...
    def generate(width, difficulty):
        ...
        :return:
        """
        puzzle = Sudoku(width, difficulty)
        return puzzle

    @staticmethod
    def solve(arr: list[list[int]]):
        """
        Bitmask algorithm to solve a Sudoku puzzle.
        THIS FUNCTION IS COPIED FROM https://www.geeksforgeeks.org/sudoku-backtracking-7/
